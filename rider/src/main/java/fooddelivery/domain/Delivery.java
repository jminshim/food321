...
public class Delivery {
    ...
    public static void foodDeliveryInfo(FoodPicked foodPicked) {
        /** Example 1:  new item 
        ...
        */
        ...
        repository().findById(foodPicked.get???()).ifPresent(delivery->{
    ...
    public static void foodDeliveryInfo(DeliveryConfirmed deliveryConfirmed) {
        /** Example 1:  new item 
        Delivery delivery = new Delivery();
        repository().save(delivery);
        ...
        */
        ...
        repository().findById(deliveryConfirmed.get???()).ifPresent(delivery->{
